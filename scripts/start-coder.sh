...
HOST="${HOST:-127.0.0.1}"
TOOLS_TEMPLATE="${CODER_TOOLS_TEMPLATE:-/srv/orchestrator/config/qwen3-tools.jinja}"

# -- Preset + model (CODER-specific; defaults overridable by env) ------------
PRESET="${CODER_PRESET:-/srv/llama/presets/Qwopus3.6-27B-Coder-MTP-Q5_K_M.conf}"
